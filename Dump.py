...
def main_menu():
	...
	print(" Code Teaches You How To Face Big Problems ! ")
	print(50*'-')
	print('[1] Create Simple File    ')
	print('[2] Create Unlimited File  ')
	print('[3] Create New Ids File ')
	print('[4] Create File By File ')
	print('[5] Extract Ids Choice Links ')
	print('[6] Seprate Ids ')
	print('[7] Sort Ids')
	print('[8] Remove Dubble Ids')
	print('[9] Divide Big File ')
